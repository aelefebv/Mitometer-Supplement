...
allOutHeaders = {'MajAx', 'MinAx', 'ZAx', 'Sol', 'Surf', 'Vol', 'Int', 'MedianSpeed', 'MeanSpeed', 'MaxSpeed', 'Directionality', 'MaxDisplacement', 'Fission', 'Fusion', 'SampleNum', 'Invasivity', 'ReceptorPos', 'MutTP53', 'Caucasian', 'Ductal', 'Age'};
