...
allOutHeaders = {'fracB','MajAx', 'MinAx', 'Sol', 'Peri', 'Area', 'Int', 'MedianSpeed', 'MeanSpeed', 'MaxSpeed', 'Directionality', 'MaxDisplacement', 'Fission', 'Fusion', 'SampleNum', 'Invasivity', 'ReceptorPos', 'MutTP53', 'Caucasian', 'Ductal', 'Age'};
